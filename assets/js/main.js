SUBJECTS = ["Uber, pero para", "Pastelería, pero para", "Uber Eats, pero con", "Reparto a domicilio de", "Tinder, pero para", "Fonda de", "Drones para", "Generador de", "Crowdsourcing para", "Blockchain para", "Machine Learning de", "Subway, pero de", "Facebook, pero para", "Pokémon Go, pero con", "Snapchat, pero para", "Instagram, pero para", "Criptomoneda para", "Cloud Computing para", "Hackeo a", "Una nueva red social, pero solo con", "Deep Learning sobre", "Votación electrónica para", "Mall para", "U-Cursos, pero con", "WhatsApp, pero para", "Fotolog, pero con", "MSN Messenger, pero de", "Agencia de Viajes para", "Organizadora de Eventos para", "Netflix, pero de", "Pago electrónico para", "Tienda 24/7 de", "Feria Empresarial enfocada en", "Impresora 3D de", "Viajes internacionales para", "Airbnb, pero para", "Fintech enfocada en", "App de trueque de", "Mayonesa de", "Pasapalabra, pero de", "Videotutoriales de", "Un CHATBOT de", "Waze, pero para"];
